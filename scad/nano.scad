...
if (afficher_nano == "o") {
  if (rotation_360 == "x" && mouvement_hauteur == "n")
    rotate([360 * $t, 0, 0]) {
      modele_nano();
    }
  ...
  if (rotation_360 == "x" && mouvement_hauteur == "o")
    rotate([360 * $t, 0, 0]) translate([0, 0, -50]) translate([0, 0, 50.3 * $t]) {
          modele_nano();
        }
  else if (rotation_360 == "y" && mouvement_hauteur == "o")
    rotate([0, 360 * $t, 0]) translate([0, 0, -50]) translate([0, 0, 50.3 * $t]) {
          modele_nano();
        }
  else if (rotation_360 == "z" && mouvement_hauteur == "o")
    rotate([0, 0, 360 * $t]) translate([0, 0, -50]) translate([0, 0, 50.3 * $t]) {
          modele_nano();
        }
  else if (rotation_360 == "n" && mouvement_hauteur == "o")
    translate([0, 0, -50]) translate([0, 0, 50.3 * $t]) {
        modele_nano();
      }
